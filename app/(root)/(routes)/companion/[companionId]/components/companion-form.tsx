        ...
        <div className="h-full p-4 space-y-2 max-w-3xl mx-auto" >
          ...
          <div className="space-y-2 w-full ">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                General information about the Celebrity
              </p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input disabled={isLoading} placeholder="Mani" {...field} />
                  </FormControl>
                  <FormDescription>
                    This is how your Celeb  will be named.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={isLoading} placeholder="UG Student" {...field} />
                  </FormControl>
                  <FormDescription>
                    Short description for your Celeb
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="space-y-2 w-full">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Detailed instructions for Celeb Behaviour
              </p>
            </div>
            <Separator className="bg-primary/10" />
          </div>
